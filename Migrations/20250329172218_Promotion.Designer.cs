...
namespace ASP_P22.Migrations
{
    ...
    [Migration("20250329172218_Promotion")]
            ...
            modelBuilder.Entity("ASP_P22.Data.Entities.Promotion", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("83f30e4c-4378-4496-91da-77bf4e8cfb88"),
                            Description = "Знижка на всі товари 10%",
                            DiscountPercentage = 10m,
                            EndDate = new DateTime(2025, 4, 29, 17, 22, 17, 963, DateTimeKind.Utc).AddTicks(7270),
                            Name = "Весняний розпродаж",
                            StartDate = new DateTime(2025, 3, 29, 17, 22, 17, 963, DateTimeKind.Utc).AddTicks(7267)
                        });
                });
            ...
            modelBuilder.Entity("ProductPromotion", b =>
                {
                    ...
                    b.ToTable("ProductPromotions", "site");
                });
